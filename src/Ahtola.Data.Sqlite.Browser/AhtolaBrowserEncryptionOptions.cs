...
public sealed class AhtolaBrowserEncryptionOptions : IDisposable
{
    ...
    private AhtolaBrowserEncryptionOptions(AhtolaEncryptionCipher cipher, byte[] secret)
    {
        Cipher = cipher;
        _secret = secret;
    }
        ...
        ReadOnlySpan<byte> key)
    {
        ...
        return new AhtolaBrowserEncryptionOptions(cipher, key.ToArray());
    }
    ...
    internal AhtolaBrowserEncryptionOptions CreateOwnedCopy()
    {
        ...
        return new AhtolaBrowserEncryptionOptions(Cipher, secret.AsSpan().ToArray());
    }
    ...
    /// <summary>
    /// Creates the pure-managed AEGIS page cipher.
    /// </summary>
