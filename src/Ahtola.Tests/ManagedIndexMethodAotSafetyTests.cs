...
public sealed class ManagedIndexMethodAotSafetyTests
{
    ...
    public void BuiltinFunctionRegistrationMatchesTheEvaluatorSurface()
    {
        ...
        // Turso registers every FTS scalar as deterministic. Keep the managed registry aligned even
        // though the planned fts_score path can consult corpus statistics.
        foreach (var name in new[] { "FTS_MATCH", "FTS_SCORE", "FTS_HIGHLIGHT", "FTS_HIGHLIGHT_LEGACY", "FTS_SNIPPET" })
